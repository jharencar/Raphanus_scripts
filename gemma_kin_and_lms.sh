...
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -o anthocyanins_raph1_gemma_output
...
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 2 -o carotenoids_raph1_gemma_output

# run gemma for Glucobrassicin_treatment_1 
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 9 -o Glucobrassicin_treatment_1_raph1_gemma_output

# run gemma for Glucoerucin_treatment_1
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 7 -o Glucoerucin_treatment_1_raph1_gemma_output

# run gemma for Glucoraphanin_treatment_1
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 4 -o Glucoraphanin_treatment_1_raph1_gemma_output

# run gemma for Glucoraphenin_treatment_1
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 5 -o Glucoraphenin_treatment_1_raph1_gemma_output

# run gemma for 4.Methylthio.3.butenyl.glucosinolate_trea
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 8 -o X4.Methylthio.3.butenyl.glucosinolate_treatment_1_raph1_gemma_output

# run gemma for unknown1_treatment_1 
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 3 -o unknown1_treatment_1_raph1_gemma_output

# run gemma fori unknown2_treatment_1
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 6 -o unknown2_treatment_1_raph1_gemma_output
