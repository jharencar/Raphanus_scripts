...
# set vairables
PLINK_PREFIX=./input/plink_filtered_58.2_138.1_rmd_0.1geno_0.5mind
KINSHIM_M=raph_gemma_kinship_0.1geno
...
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 2 -o anthocyanins_0.1geno_gemma_output
...
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 3 -o carotenoids_0.1geno_gemma_output

# run gemma for Glucobrassicin
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 10 -o Glucobrassicin_RR_0.1geno_gemma_output

# run gemma for Glucoerucin
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 8 -o Glucoerucin_RR_0.1geno_gemma_output

# run gemma for Glucoraphanin
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 5 -o Glucoraphanin_RR_0.1geno_gemma_output

# run gemma for Glucoraphenin
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 6 -o Glucoraphenin_RR_0.1geno_gemma_output

# run gemma for 4.Methylthio.3.butenyl.glucosinolate
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 9 -o X4.Methylthio.3.butenyl.glucosinolate_RR_0.1geno_gemma_output

# run gemma for unknown1
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 4 -o unknown1_RR_0.1geno_gemma_output

# run gemma for unknown2
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 7 -o unknown2_RR_0.1geno_gemma_output

# run gemma for GS_OX_function
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 11 -o GS_OX_function_RR_0.1geno_gemma_output

# run gemma for DOG_function
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 12 -o DOG_function_RR_0.1geno_gemma_output

# run gemma for prop_indolic
gemma -bfile "$PLINK_PREFIX" -k ./output/${KINSHIM_M}.cXX.txt -miss $MISS -lm 1 -n 13 -o prop_indolic_RR_0.1geno_gemma_output
